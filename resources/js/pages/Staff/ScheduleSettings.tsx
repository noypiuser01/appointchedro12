                ...
                <div className="flex">
                    ...
                    <div className="mb-6">
                        ...
                        <div className="bg-white rounded-lg shadow p-6">
                            <h1 className="text-2xl font-bold text-gray-900 mb-6">Schedule Settings</h1>
                                    ...
                                    <div className="border rounded-lg p-4">
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <button
                                                ...
                                                className="w-full inline-flex items-center justify-center px-4 py-2 text-sm rounded-md text-white"
                                                style={{ backgroundColor: '#2563eb', opacity: !selectedDate || !title || loading ? 0.7 : 1 }}
                                            >
                                                Save Appointment
                                            </button>
                                        </div>
                    ...
                    <div className="relative bg-white rounded-lg shadow-xl w-full max-w-md mx-4">
                        ...
                        <div className="px-6 py-4 border-t flex justify-end space-x-3">
                            ...
                            <button
                                ...
                                style={{ backgroundColor: '#2563eb', opacity: !title || loading ? 0.7 : 1 }}
                            >

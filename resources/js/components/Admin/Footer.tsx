                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="col-span-1 md:col-span-1">
                        ...
                        <p className="text-blue-200 text-xs leading-relaxed">
                            Admin portal for appointment management system.
                        </p>
                    </div>

                    {/* Quick Links */}
                    <div className="col-span-1 md:col-span-1">
                        <h3 className="text-sm font-semibold mb-2">Admin Tools</h3>
                        <ul className="space-y-1">
                            <li>
                                <Link href="/admin/dashboard" className="text-blue-200 hover:text-white text-xs transition-colors">
                                    Dashboard
                                </Link>
                            </li>
                            <li>
                                <Link href="/admin/users" className="text-blue-200 hover:text-white text-xs transition-colors">
                                    User Management
                                </Link>
                            </li>
                            <li>
                                <Link href="/admin/appointments" className="text-blue-200 hover:text-white text-xs transition-colors">
                                    Appointments
                                </Link>
                            </li>
                        </ul>
                    ...
                    <div className="col-span-1 md:col-span-1">
                        ...
                        <div className="space-y-1 text-xs text-blue-200">
                            <p>Email: admin@chedregion12.gov.ph</p>
